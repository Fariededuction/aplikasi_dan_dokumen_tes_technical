            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <?= form_open('Login/tambah_data_register'); ?>
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="acceptTerms">Saya setuju<a href="#">dengan segala ketentuan yang berlaku</a></label>
                        <div class="invalid-feedback">harus centang setuju dulu.</div>
                      </div>
                    </div>
                    <div class="col-12">
